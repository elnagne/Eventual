...
const MOCK_EVENTS = [
  ...
  },
  {
    ...
    city: "Mississauga",
    category: "Movies",
    address: "A-67 Discrete St.",
  },
  {
    event_name: "Snowboarding Sunday",
    image_url:
      "https://www.gannett-cdn.com/authoring/2012/01/18/NLAJ/ghows-TX-0b0285d1-6dab-4ab7-a1b4-b3e6c8a3bd6a-4edfb557.jpeg?width=1200&disable=upscale&format=pjpg&auto=webp",
    author: "Richard Pancer",
    startTime: "2023-04-09T14:00:00.000Z",
    endTime: "2023-04-09T16:30:00.000Z",
    description: "Snowboard with me and my sister.",
    num_likes: 1,
    city: "Toronto",
    category: "Sports",
    address: "C-37 Numerical Ave.",
  },
  {
    event_name: "Tennis Doubles",
    image_url:
