...
import { faHome, faCalendarAlt, faCogs, faThumbsUp, faHistory, faPlus, faUser, faUserPlus, faQuestion, faSignIn, faSignOut, faCalendarCheck } from '@fortawesome/free-solid-svg-icons'
...
const SidebarPro = () => {
    ...
    return (
        <div className='sidebarproWrapper'>
            <ProSidebar collapsed={collapsed} breakPoint="xs" image={sidebarBg} onMouseOver={() => { setCollapsed(false) }} onMouseOut={() => { setCollapsed(true) }}>
                <SidebarHeader>
                ...
                <SidebarContent>
                    <Menu>
                        ...
                        {username == null &&
                            <MenuItem icon={<FontAwesomeIcon icon={faUserPlus} />} onClick={() => { setModalOpen(true) }}>
                                Register
                            </MenuItem>
                        }
                        {username == null &&
